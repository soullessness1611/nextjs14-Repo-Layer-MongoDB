...
import { BookCard } from "@/Client/Coponents/Home/BookCard";
  ...
  return (
    <div className="home-page w-full px-8 grow flex flex-col mt-2">
      ...
      <span className="text-sm">
        {books.length} of {totalCount} Items
      </span>
      <div className="mt-6 result-container">
        <Suspense
          fallback={
            <h6 className="text-center ltr">📡 Loading data please wait ...</h6>
          }
        >
          {books?.length ? (
            <>
              ...
              <Pagination
                ...
                itemPerPage={10} // Replace this with your actual items per page
              />
            </>
          ) : (
